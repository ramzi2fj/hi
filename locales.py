...
locale_fa.too_long_message = '🥺 با عرض پوزش چون پیام شما بیشتر از 200 حروف است امکان ارسال آن نیست . '
...
locale_fa.for_message = 'پیام خصوصی برای %s.'
...
locale_fa.except_message = 'پیام خصوصی برای همه به جز  %s.'
...
locale_fa.spoiler_message = 'پیام اسپویلر عمومی :'
...
locale_fa.how_to_use = 'چگونه از این ربات استفاده کنم ؟'
...
locale_fa.too_long_description = 'لطفا طول پیام خود را کوتاه کنید تا از 200 حروف بیشتر نشود.'
...
locale_fa.not_allowed = 'شما مجاز به مشاهده این محتوا نیستید.'
...
locale_fa.not_accessible = 'این محتوا دیگر در دسترس نیست.'
